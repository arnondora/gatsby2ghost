...
class Post: 
    ...
    def convert_feature_image_path (self, image_dict) :
        if getattr(self, 'feature_image', False) :
            self.feature_image = image_dict[self.feature_image]
    ...
    def __init__(self, file_path):
        ...
        for metadata in metadata_list :
            ...
            if decomposed_meta[0] == 'title' :
                ...
                self.post.feature_image = feature_image_name.replace('"', '').replace('./', '').replace(' ' ,'')
